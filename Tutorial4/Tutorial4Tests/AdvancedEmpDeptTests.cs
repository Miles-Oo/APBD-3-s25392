...
public class AdvancedEmpDeptTests
{
    ...
    public void ShouldReturnEmployeesWithManagers()
    {
        ...
        var withMgr = emps
            .Where(e => e.Mgr != null)  // Pracownicy, którzy mają przypisanego menedżera
            .ToList();
    ...
    public void ShouldReturnEmployeeManagerPairs()
    {
        ...
        var result = emps
            .Where(e1 => e1.Mgr != null)  // Filtracja tylko tych pracowników, którzy mają menedżera
            .Select(e1 => new 
            {
                Employee = e1.EName,
                Manager = emps.FirstOrDefault(e2 => e2.EmpNo == e1.Mgr)?.EName  // Znajdowanie menedżera
            })
            .ToList();
    ...
    public void ShouldReturnTotalIncomeIncludingCommission()
    {
        ...
        var result = emps
            ...
            {
                e.EName,
                Total = e.Sal + (e.Comm ?? 0)  // Używamy ?? do zastąpienia null prowizji 0
            })
            .ToList();
